                ...
                <form action="{{ route('complaints.index') }}" method="GET" class="flex flex-col sm:flex-row gap-4">
                    <div class="flex-grow">
                        ...
                        <div class="relative group">
                            ...
                            <input type="text" name="search" id="search" value="{{ request('search') }}" class="form-input pl-11 py-3 bg-white" style="color: #1f2937;" placeholder="Search by title, description or ID...">
                        </div>
                    </div>

                ...
                <form action="{{ route('complaints.store') }}" method="POST" enctype="multipart/form-data" class="space-y-10">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2 group">
                                <label for="title" class="form-label group-focus-within:text-portal-700 transition-colors">Title</label>
                            ...
                            <div class="md:col-span-2 group">
                                <label for="category_id" class="form-label group-focus-within:text-portal-700 transition-colors">Category</label>
                            ...
                            <div class="md:col-span-2 group">
                                <label for="description" class="form-label group-focus-within:text-portal-700 transition-colors">Complaint Description</label>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="group">
                                <label for="block" class="form-label group-focus-within:text-portal-700 transition-colors">Block</label>
                            ...
                            <div class="group">
                                <label for="floor" class="form-label group-focus-within:text-portal-700 transition-colors">Floor</label>
                            ...
                            <div class="group">
                                <label for="room_number" class="form-label group-focus-within:text-portal-700 transition-colors">Room Number</label>
                            ...
                            <div class="md:col-span-3 group">
                                <label for="area_location" class="form-label group-focus-within:text-portal-700 transition-colors">Area/Location <span class="text-rose-500">*</span></label>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="group">
                                <label for="contact_number" class="form-label group-focus-within:text-portal-700 transition-colors">Contact Number <span class="text-rose-500">*</span></label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <svg class="h-5 w-5 text-slate-400 group-focus-within:text-portal-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                                    </div>
                            ...
                            <div class="group">
                                <label for="availability_date" class="form-label group-focus-within:text-portal-700 transition-colors">Availability Date <span class="text-rose-500">*</span></label>
                            ...
                            <div class="group">
                                <label for="preferred_time_slot" class="form-label group-focus-within:text-portal-700 transition-colors">Preferred Visit Time <span class="text-rose-500">*</span></label>
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex justify-center px-6 pt-8 pb-8 border-2 border-slate-200 border-dashed rounded-2xl bg-slate-50/50 hover:bg-portal-50/30 hover:border-portal-500 transition-all group">
                            <div class="space-y-2 text-center">
                                <div class="mx-auto w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-sm border border-slate-100 group-hover:scale-110 transition-transform mb-4">
                                    <svg class="h-8 w-8 text-portal-500" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
                                        <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>
                                <div class="flex text-sm text-slate-600 justify-center">
                                    <label for="image" class="relative cursor-pointer bg-transparent rounded-md font-bold text-portal-700 hover:text-portal-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-portal-600">
                    ...
                    <div class="flex items-center justify-end gap-4 pt-8 border-t border-slate-100">
                        ...
                        <button type="submit" class="btn btn-primary px-8 py-3 text-base shadow-lg shadow-portal-200">
                            Submit Complaint

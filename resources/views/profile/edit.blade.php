<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center animate-fade-in">
            <div class="flex items-center gap-4">
                <div class="w-12 h-12 rounded-2xl bg-portal-50 text-portal-700 flex items-center justify-center">
    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-8 animate-slide-up">
            ...
            <div class="card bg-white p-8 sm:p-10 shadow-lg shadow-slate-200/40 border-0 ring-1 ring-slate-100 hover:ring-portal-100 transition-colors">
                <div class="max-w-2xl">
